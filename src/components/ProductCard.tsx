      ...
      <div className="p-3 sm:p-4">
        ...
        <div className="flex items-center mt-1 mb-2">
          <div className="flex items-center">
            ...
            <span className="ml-1 text-xs sm:text-sm font-medium"> {product.averageRating} </span>
          </div>
          <span className="mx-2 text-gray-300">|</span>
          <span className="text-xs sm:text-sm text-gray-600"> {product.totalReviews}  reviews</span>
        </div>
